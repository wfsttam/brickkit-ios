...
class FillBrickViewController: BrickViewController {
    ...
    override func viewDidLoad() {
        ...
        let section = BrickSection(bricks: [
            LabelBrick(width: .Fixed(size: 50), backgroundColor: .brickGray1, text: "BRICK", configureCellBlock: LabelBrickCell.configure),
            ...
            LabelBrick(width: .Fixed(size: 50), backgroundColor: .brickGray2, text: "BRICK", configureCellBlock: LabelBrickCell.configure),
            BrickSection(width: .Fill, backgroundColor: .brickGray4, bricks: [
                LabelBrick(width: .Ratio(ratio: 0.25), backgroundColor: .brickGray1, text: "BRICK", configureCellBlock: LabelBrickCell.configure),
                LabelBrick(width: .Fill, backgroundColor: .brickGray3, text: "BRICK", configureCellBlock: LabelBrickCell.configure),
                ])
